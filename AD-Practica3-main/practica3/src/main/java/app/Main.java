...
public class Main {
    ...
    private static ODB odb = ODBFactory.open("test.neodatis");
    ...
    static void listarProfesoresNac() {
        for (Profesor p : profesorDao.getAll(odb)) {
            int year = Integer.parseInt(p.getFechaNacimiento().substring(6, 10));
            if (year < 1993) {
    ...
    static void listarProfesoresMA() {
        for (Profesor p : profesorDao.getAll(odb)) {
            for (Asignatura a : p.getAsignaturas()) {
                if (p.getSexo().equals("M") && a.getNombre().equals("Acceso a datos")) {
                    System.out.println(p.toString());
                }
            }
        }
    ...
    static void poblarBD() {
        ...
        Centro c1 = new Centro(1, "IES ITACA", "Av Estudiantes", "Zaragoza", "Zaragoza");
        Centro c2 = new Centro(2, "Colegio Hermanos Argensola", "Calle Mayor", "Zaragoza", "Zaragoza");

        // Crecion de 6 profesores
        Profesor p1 = new Profesor(1, "Ivan", "Calvo", "M", "10/06/2000");
        Profesor p2 = new Profesor(2, "Paco", "Jemez", "M", "29/07/2000");
        Profesor p3 = new Profesor(3, "Jaime", "Welter", "M", "02/02/1999");
        Profesor p4 = new Profesor(4, "Antonio", "Lebrero", "M", "17/04/1991");
        Profesor p5 = new Profesor(5, "Sonia", "Varas", "F", "21/02/1995");
        Profesor p6 = new Profesor(6, "Maria", "Roy", "F", "19/11/1988");

        // Creacion de 8 asignaturas
        Asignatura a1 = new Asignatura(1, "Programacion de servicios y procesos");
        ...
        Asignatura a6 = new Asignatura(6, "Lenguaje de Marcas");
        Asignatura a7 = new Asignatura(7, "Formacion y orientacion laboral");
